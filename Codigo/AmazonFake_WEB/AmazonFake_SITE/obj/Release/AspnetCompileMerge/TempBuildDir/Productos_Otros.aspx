<%@ Page Title="" Language="C#" MasterPageFile="~/AmazonFake.Master" AutoEventWireup="true" CodeBehind="Productos_Otros.aspx.cs" Inherits="AmazonFake_SITE.Productos_Otros" %>
        ...
        <asp:TableRow>
            <asp:TableCell>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SQL_AUTH%>" 
                    SelectCommand="SELECT codproducto,desproducto,codcategoria,preproducto,canproducto,imagen FROM PRODUCTOS Where codcategoria = 1"></asp:SqlDataSource>
            </asp:TableCell>
        </asp:TableRow>
    </asp:Table>
</div>
