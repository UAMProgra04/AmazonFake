...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="SectionForm">
        ...
        <asp:TextBox class="input_Formulario" ID="txt_Old_Password" required="required" runat="server"
        ...
        <asp:TextBox class="input_Formulario" ID="txt_New_Password" required="required" runat="server"
            pattern="[a-zA-Z0-9]{4,12}" MaxLength="12"></asp:TextBox>
        <hr />
