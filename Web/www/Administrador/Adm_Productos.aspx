...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <center>
            ...
            <br />
            <asp:Button ID="btn_Agregar_Articulo" runat="server" Text="Agregar Producto" OnClick="btn_Agregar_Articulo_Click"></asp:Button>
        </center>
    </div>
    <hr />
    <div>
        ...
        <asp:Table ID="Table2" runat="server">
            ...
            <asp:Label ID="Label9" runat="server" Text="Nota: Los Productos se eliminan por medio de su nombre"></asp:Label>
        </center>
    </div>
